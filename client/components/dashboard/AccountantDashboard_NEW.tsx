  ...
  return (
    <motion.div custom={index} variants={fadeUp} initial="hidden" animate="visible">
      <Link href={href} className="block group">
        <Card className="h-full border border-slate-200 hover:border-teal-300 hover:shadow-md transition-all duration-200 cursor-pointer overflow-hidden">
          <CardContent className="p-5">
            <div className="flex items-start gap-4">
              ...
              <ArrowRight className="h-4 w-4 text-slate-300 group-hover:text-teal-500 group-hover:translate-x-1 transition-all duration-200 shrink-0 mt-0.5" />
            </div>
          </CardContent>
        </Card>
      </Link>
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-teal-600 via-teal-500 to-cyan-600 p-6 text-white shadow-lg"
      >
        {/* decorative circles */}
        ...
        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-teal-200 text-sm font-medium">Accountant Portal</span>
            </div>
        ...
        <TabsList className="flex flex-wrap h-auto gap-1 bg-slate-100 p-1 rounded-xl">
          {[
            ...
            <TabsTrigger
              key={tab.value}
              value={tab.value}
              className="rounded-lg text-sm data-[state=active]:bg-white data-[state=active]:text-teal-600 data-[state=active]:shadow-sm px-4 py-2"
            >
              {tab.label}
            </TabsTrigger>
          ))}
            ...
            <motion.div key="overview" variants={tabContent} initial="hidden" animate="visible" exit="exit" className="space-y-6">
              ...
              <div>
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                  {[
                    { label: 'View Timetable', href: '/dashboard/academic/timetable', icon: <CalendarDays className="h-4 w-4" />, color: 'bg-teal-500 hover:bg-teal-600' },
                    ...
                    {upcomingExams.length === 0 ? (
                      ...
                      <div className="space-y-3">
                        {upcomingExams.slice(0, 5).map((exam: any, i: number) => {
                          ...
                          return (
                            <div key={exam.id ?? i} className="flex items-center justify-between rounded-lg border border-slate-100 p-3 hover:border-teal-200 hover:bg-teal-50/30 transition-colors">
            ...
            <motion.div key="academic" variants={tabContent} initial="hidden" animate="visible" exit="exit" className="space-y-6">
              <div>
                ...
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  <FeatureCard
                    index={8}
                    icon={<CalendarCheck className="h-5 w-5 text-teal-700" />}
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Link href="/dashboard/attendance/student">
                        <Button variant="ghost" size="sm" className="text-teal-600 hover:text-teal-700 h-7 px-2">
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Link href="/dashboard/announcements">
                      <Button variant="ghost" size="sm" className="text-teal-600 hover:text-teal-700 h-7 px-2 text-xs">
                ...
                <CardContent>
                  <div className="space-y-3">
                    {[
                      ...
                      { title: 'Annual Sports Day Registration Open', time: '2 days ago', type: 'Event', color: 'bg-teal-100 text-teal-700' },
              ...
              <Card className="border border-slate-200 bg-gradient-to-br from-blue-50 to-indigo-50">
                <CardContent className="p-5">
                  <div className="flex items-center gap-4">
                    <div className="rounded-xl bg-teal-100 p-3 shrink-0">
              ...
              <Card className="border border-slate-200">
                ...
                <CardContent>
                  <div className="flex items-start gap-5">
                    {/* Avatar */}
                    <div className="h-16 w-16 rounded-2xl bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center text-white text-2xl font-bold shrink-0 shadow-md">
                  ...
                  <div className="mt-5 grid gap-3 sm:grid-cols-3">
                    {[
                      { label: 'Attendance', value: `${attendancePct}%`, icon: <CalendarCheck className="h-4 w-4 text-teal-500" /> },
                ...
                <CardContent>
                  <div className="space-y-2">
                    {[
                      ...
                      { label: 'Privacy Settings', desc: 'Control your data and visibility', icon: <Settings className="h-4 w-4 text-teal-500" />, href: '/dashboard/profile' },
                    ].map((item, i) => (
                ...
                <CardContent>
                  <div className="grid gap-3 sm:grid-cols-3">
                    {[
                      ...
                      { icon: <Award className="h-6 w-6 text-teal-500" />, label: 'Perfect Attendance', desc: 'October 2024', bg: 'from-blue-50 to-indigo-100' },
              ...
              <Card className="border border-slate-200">
                ...
                <CardContent>
                  <div className="grid gap-2 sm:grid-cols-2">
                    {[
                      { label: 'Bonafide Certificate', icon: <FileText className="h-4 w-4 text-teal-500" /> },
                      ...
                      <Link key={i} href="/dashboard/services">
                        <div className="flex items-center gap-3 p-3 rounded-lg border border-slate-100 hover:border-teal-200 hover:bg-teal-50/30 transition-colors cursor-pointer group">
                          ...
                          <Download className="h-3.5 w-3.5 text-slate-300 group-hover:text-teal-500 transition-colors" />
                        </div>
                      </Link>
                    ))}
                  </div>
